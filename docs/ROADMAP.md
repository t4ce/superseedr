...
- Networking reachability/features beyond shipped TCP+uTP transport (IPv6,
  UPnP, hole punch, DHT search).
...
- **phase: 2 - v2.0+** | IPv6 - transport capability expansion | [Issue #____]
